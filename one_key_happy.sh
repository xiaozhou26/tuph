...
+----------------------------------------------------------------------
| 安装脚本：curl -sSO http://jsd.cdn.zzko.cn/gh/ztkink/bthappy@latest/install_panel.sh && bash install_panel.sh
+----------------------------------------------------------------------
"
while [ "$go" != 'y' ] && [ "$go" != 'n' ]
do
...
if [ -f ${plugin_file} ];then
    ...
    wget http://jsd.cdn.zzko.cn/gh/ztkink/bthappy@latest/plugin.json
    chattr +i /www/server/panel/data/plugin.json
else
    cd /www/server/panel/data
    wget http://jsd.cdn.zzko.cn/gh/ztkink/bthappy@latest/plugin.json
...
if [ -f ${repair_file} ];then
    ...
    cd /www/server/panel/data
    wget http://jsd.cdn.zzko.cn/gh/ztkink/bthappy@latest/repair.json
    chattr +i /www/server/panel/data/repair.json
else
    cd /www/server/panel/data
    wget http://jsd.cdn.zzko.cn/gh/ztkink/bthappy@latest/repair.json
